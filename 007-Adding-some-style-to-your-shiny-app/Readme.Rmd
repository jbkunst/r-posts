...
Fisrt of all, there are a good [post](http://shiny.rstudio.com/articles/css.html) in Rstudio's blog where they explain how add styles in a shiny app. But that is only the beginning.

This post it's only to show what can you do if you have an idea or inspiration.
