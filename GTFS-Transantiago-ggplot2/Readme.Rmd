...
You can also export the image in a high resolution pds like [this](https://github.com/jbkunst/r-posts/blob/master/01-ggplot2-GTFS-Transantiago/plot/gtfs_transantiago_hires.pdf?raw=true#page=1)
