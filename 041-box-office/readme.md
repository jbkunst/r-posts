...
##   (dbl)                        (chr)  (chr)     (dbl) (dbl)
## 1     1 Star Wars: The Force Awakens     BV 930901726  2015
## 2     2                       Avatar    Fox 760507625  2009
## 3     3                      Titanic    Par 658672302  1997
## 4     4               Jurassic World    Uni 652270625  2015
## 5     5        Marvel's The Avengers     BV 623357910  2012
## 6     6              The Dark Knight     WB 534858444  2008
## Variables not shown: url_movie (chr), have_release (lgl), box_id (chr),
##   distributor (chr), genre (chr), mpaa_rating (chr), runtime (chr),
##   production_budget (chr), img_url (chr), img_main_color (chr), max_day
##   (dbl)
```
