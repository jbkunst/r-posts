...
Usually (mainly at work) I made a chart and the present it but nobody 
cares about the style, if the chart comes from an excel spreadsheet, paint or
...
But hey! That's not implies your only must do always clean or tufte style plots.
...
<!--html_preserve--><div id="htmlwidget-34b4c81c7fb93eb269bf" style="width:100%;height:500px;" class="highchart html-widget"></div>
<script type="application/json" data-for="htmlwidget-34b4c81c7fb93eb269bf">{
  "x": {
    "hc_opts": {
      "title": {
        "text": null
      ...
      "series": [
        {
          ...
          "data": [
            ...
            },
            {
              ...
              "opened_by": "President Mika Špiljak",
              "dates": "8–19 February",
              "nations": 49,
              "competitors": 1272,
              "competitors_2": 998,
...
## $ top_nation    <chr> "Norway (NOR)", "Norway (NOR)", "United States (...
## $ ref           <chr> "[2]", "[3]", "[4]", "[5]", "[6]", "[7]", "[8]",...
## $ country       <chr> "France", "Switzerland", "United States", "Germa...
...
ttvars <- c("year", "nations", "sports", "competitors", "events")
tt <- tooltip_table(
  ttvars,
...
hcgames2 <- hchart(dgames, "areaspline", hcaes(year, nations, name = host), name = "Nations") %>% 
  ...
  hc_tooltip(
    headerFormat = as.character(tags$h3("{point.key}", tags$br())),
    pointFormat = tt,
    useHTML = TRUE,
    backgroundColor = "transparent",
    ...
    positioner = JS("function () { return { x: this.chart.plotLeft + 15, y: this.chart.plotTop + 15 }; }"),
    shape = "square"
  ) %>% 
  hc_plotOptions(
    series = list(
...
<!--html_preserve--><div id="htmlwidget-9e8fd09bf4f429841ab7" style="width:100%;height:500px;" class="highchart html-widget"></div>
<script type="application/json" data-for="htmlwidget-9e8fd09bf4f429841ab7">{
  "x": {
    "hc_opts": {
      "title": {
        "align": "left",
      ...
      "tooltip": {
        ...
        "positioner": "function () { return { x: this.chart.plotLeft + 15, y: this.chart.plotTop + 15 }; }",
        "shape": "square"
      }
    },
    "theme": {
...
> Retrieved from: https://ourworldindata.org/oil-spills/
...
Let's load the data and make the basic not styled chart.
...
here to make a _liquid_ effect after. 
...
<!--html_preserve--><div id="htmlwidget-ba39f66749c3fc234ae9" style="width:100%;height:500px;" class="highchart html-widget"></div>
<script type="application/json" data-for="htmlwidget-ba39f66749c3fc234ae9">{
  "x": {
    "hc_opts": {
      "title": {
...
- Add a sea/water background.
- Reverse the `yAxis` to the give the _fall_ effect. 
- Add a dark/_oil_ colors.
...
<!--html_preserve--><div id="htmlwidget-000d6a54a124b58aaaef" style="width:100%;height:500px;" class="highchart html-widget"></div>
<script type="application/json" data-for="htmlwidget-000d6a54a124b58aaaef">{
  "x": {
    "hc_opts": {
      "title": {
        "text": "Number of Oil Spills Over the Past 4 Decades",
