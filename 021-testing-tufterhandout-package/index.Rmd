---
title: "Example and improvement Default for Tufte-style Handouts (for Web Use)"
author: "Joshua Kunst"
date: "`r Sys.Date()`"
output: 
...
<link href="tufte2.css" media="all" rel="stylesheet" />
...
Based on http://motioninsocial.com/tufte/ and https://cran.r-project.org/web/packages/tufterhandout/vignettes/example.html
...
```{r fig2, tidy = TRUE, fig.width = 22, fig.height = 5, fig.cap = "Full-width figure", fig.star = TRUE}
...
- https://cran.r-project.org/web/packages/tufterhandout/vignettes/example.html
